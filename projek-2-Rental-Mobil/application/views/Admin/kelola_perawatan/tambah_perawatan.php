                    ...
                    <div class="card p-2">
                        <div class="card-body">
                            ...
                            <div class="col-12 m-auto">
                                <form action="<?php echo base_url("index.php") ?>/Admin/Kelola_perawatan/save" method="post" atanggalept-charset="utf-8">
                                    ...
                                    <fieldset class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            ?>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="jenis" id="gridRadio<?= $range->id ?>" value="<?= $range->id ?>">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="km_mobil" name="km_mobil" type="number" class="form-control" required>
                                        </div>
                                    </div>
