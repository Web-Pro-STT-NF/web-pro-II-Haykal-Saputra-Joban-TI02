                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="<?php echo base_url('index.php') ?>/dashboard" class="logo d-flex align-items-center w-auto">
                                    <img src="<?php echo base_url('assets/img/Rental_Cars.jpeg')?>" alt="">
                                    <span class="d-none d-lg-block">Rental Cars</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="credits">
                                ...
                                Designed by <strong>Rental </strong>Cars
                            </div>
