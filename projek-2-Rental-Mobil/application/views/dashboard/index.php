                                    ...
                                    <fieldset class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="merk" id="gridRadios1" value="public" <?= $roleCheck ?>>
                                                <label class="form-check-label" for="gridRadios1">
                                                    public
                                                </label>
                                            </div>
                                            <div class="form-check <?= $disable ?>">
                                                <input class="form-check-input" type="radio" name="merk" id="gridRadios2" value="administrator" <?= $adminCheck ?> <?= $disable ?>>
